...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,
        help="Output artifact name to create (e.g., 'clean_sample.csv')",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type=float,
        help="Minimum price to keep (rows with price below are dropped)",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum price to keep (rows with price above are dropped)",
        required=True
    )
